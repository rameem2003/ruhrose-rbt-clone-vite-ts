      ...
      <Container>
        <div className="w-full">
          <ComponentReveal y={-50}>
            <h4 className=" text-secondary text-2xl md:text-4xl font-title-two font-semibold">
              Our Catagories Lineup
            </h4>
          </ComponentReveal>

          <ComponentReveal y={-50}>
            <h2 className=" text-secondary text-xl  w-auto md:w-[700px] font-title-two font-medium mt-4">
